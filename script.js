...
const [players1, players2] = game.players; // test passed
...
// const [gkNeuer, ...fieldPlayers1] = players1; // my answer
// console.log(gkNeuer, fieldPlayers1);
...
// teams (22 players)
const allPlayers = [...players1, ...players2]; // test passed
...
const players1Final = [...players1, 'Thiago', 'Coutinho', 'Perisic']; // test passed
console.log(players1Final);

// 5. Based on the game.odds object, create one variable for each odd
// (called 'team1', 'draw' and 'team2')
// below my answer totally wrong as per the tutorial
/*
...
console.log(team2);
*/
// tutorial answer below for the above
...
function printGoals(...players) {
  // Count the total players (arguments passed)
  const numPlayers = players.length;
  console.log(`There were ${numPlayers} goals scored in total.`);
...
// Example usage by gemini way
// printGoals("Alice", "Bob", "Charlie");  // Output: There were 3 goals scored in total. Alice Bob Charlie

// tutorial way for the above question
